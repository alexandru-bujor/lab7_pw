...
type Order struct {
	...
	Status          string     `gorm:"column=status;default:pending" json:"status"` // pending | processing | completed | cancelled
	OrderSource     string     `gorm:"column=order_source;default:website" json:"order_source"` // website | manual
...
// CreateOrderInput for creating orders from website
type CreateOrderInput struct {
	...
	OrderSource    string  `json:"order_source"` // website or manual
	AccountingType string  `json:"accounting_type"` // on_book | off_book
}
