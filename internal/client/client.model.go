...
// ClientOrder represents an order placed by a client
...
// ClientOrderItem represents an item in a client's order
...
// CreateClientInput is used for creating a new client
...
// UpdateClientInput is used for updating a client
